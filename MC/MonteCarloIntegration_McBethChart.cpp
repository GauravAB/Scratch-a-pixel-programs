...
constexpr float lambdaMin = 360, lambdaMax = 730;
...
constexpr uint32_t width = squareSize * 6 , height = squareSize * 4;
uint32_t npasses = 0;


void handler(int s)
{
    printf("Saving image after %d passses\n", npasses);
    std::ofstream ofs;
    ofs.open("mcbeth1.ppm",std::ios::out|std::ios::binary);
    ofs << "P6\n" << width << " " << height << "\n255\n";
